/**
 * pdf-optimizado.js - Versión con tamaño de letra reducido y logo optimizado
 * Solución optimizada para la generación de PDF sin páginas en blanco intermedias,
 * con observaciones completas, tamaño de letra reducido y logo mejorado
 * 
 * VERSIÓN CORREGIDA: Evita la duplicación de archivos PDF
 */
...
// AÑADIR AQUÍ EL CÓDIGO PARA OCULTAR LOS BOTONES DE LAS IMÁGENES
        ...
        if (logoContainer) {
            ...
            if (logoImage) {
                ...
                logoImage.style.width =  '90px'; // Tamaño reducido
        ...
        if (titulo) {
            ...
            titulo.style.marginLeft = '05px';  // Reducido para mover a la izquierda
...
input[type="radio"] {
    ...
    vertical-align: middle !important;
            ...
            #plan-accion-editor {
                font-size: 13pt !important; /* Reducido */
                line-height: 1.4 !important; /* Mejorado para legibilidad */
                ...
                onclone: function(clonedDoc) {
                    ...
                    style.innerHTML = `
                        * {
                        ...
                        font-size: 13pt !important; /* Asegurar que todos los elementos internos tengan el mismo tamaño */
                        }
                        #plan-accion-editor ul, 
                        #plan-accion-editor ol {
                            margin: 10px 0 10px 15px !important;
    ...
    try {
        ...
        logoImg.onload = function() {
            ...
            for (let i = 1; i <= totalPaginas; i++) {
                ...
                const textWidth = pdf.getStringUnitWidth(texto) * 7 / pdf.internal.scaleFactor;
                const x = pageWidth - textWidth - 12;
                ...
                pdf.setFontSize(10); // Extremadamente pequeño
                ...
                const xCentrado = (pageWidth - textoSeguridadWidth) / 2;
                const yAbajo = pageHeight - 5; // 5mm desde el borde inferior
                
                // Añadir el texto centrado
                pdf.text(textoSeguridad, xCentrado, yAbajo);
            }
        ...
        logoImg.onerror = function() {
            ...
            for (let i = 1; i <= totalPaginas; i++) {
                ...
                // Texto a añadir
                const textoSeguridad = "Seguridad Privada O.S.10 Coquimbo";
